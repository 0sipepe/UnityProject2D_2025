...
public class Moving : MonoBehaviour
{
    ...
    int layerFloorNumber;


    private void Start()
    {
        layerFloorNumber  = (int)Mathf.Log(layerFloor.value, 2);
    ...
    private bool IsAvailableToReserveAJump()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(player, Vector2.down * reserveDistance, layerFloor);
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.layer == layerFloorNumber )
        {
